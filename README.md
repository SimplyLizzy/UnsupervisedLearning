...
* When looking at the models from the pynb file, the data shows that the cryptocurrencies can be clusetered together. I believe that anywhere from 3-4 clusters would be appropriate, and 5 clusters being too much/overlapping with other clusters.
